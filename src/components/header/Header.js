        ...
        <div className="header__row">
          ...
          <div
            ...
            className={`header__burger ${
              toggleBurger ? "header__burger_active" : null
            }`}
          >
            <span></span>
          </div>
          <nav
            className={`header__menu menu ${
              toggleBurger ? "menu_active" : null
            }`}
          >
            <div className="menu__region-mob">
              <div className="menu__flag-icon menu__flag-icon_active">
                <img src={RU} alt="ru" />
              </div>
              ...
              {items?.map((name, i) => (
                <li
                  ...
                  className={`menu__item ${
                    state === i ? "menu__item_active" : ""
                  }`}
                >
                  {name}{" "}
                  {name === "Услуги" ? (
                    <img className="menu__item-icon" src={arrow} alt="arrow" />
                  ) : null}
                </li>
              ))}
            </ul>
          ...
          <div className="header__actions actions">
            <div
              ref={popap}
              className={`actions__item actions__search-btn ${
                searchOn ? "actions__search-btn_active" : null
              }`}
            >
              <img
              ...
              {searchOn ? (
                <div className="search-popap">
                  <input
                    className="search-popap__input"
                    type="search "
                    placeholder="Поиск"
                  />
                  <img
                    className="search-popap__icon"
